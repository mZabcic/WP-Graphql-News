...
wp search-replace www.boilerplate.com temporis2.test --url=www.boilerplate.com --all-tables

# Search and replace for https to http
wp search-replace https://temporis2.test http://temporis2.test --all-tables
