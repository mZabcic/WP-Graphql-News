 ...
 *
 * @since   2.0.0
 * @package Wpbit4bytes\Admin\Menu
 */

namespace Wpbit4bytes\Admin\Menu;
...
class Menu {
  ...
  public function get_menu_positions() {
    return array(
        'header_main_nav' => esc_html__( 'Main Menu', 'wpbit4bytes' ),
        'footer_main_nav' => esc_html__( 'Footer Menu', 'wpbit4bytes' ),
    );
  }
