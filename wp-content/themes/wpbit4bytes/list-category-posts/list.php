...
https://github.com/picandocodigo/List-Category-Posts/wiki/How-to-select-which-posts-to-show
*/
/*
...
while ( have_posts() ):
  ...
  //Show date:
  $lcp_display_output .= ' <span class="__date">' . $this->get_date($post).'</span>';
  //Show date modified:
  $lcp_display_output .= ' ' . $this->get_modified_date($post);
  //Show author
  $lcp_display_output .= ' <span class="__author">' . $this->get_author($post).'</span>';
  //Custom fields:
