 ...
 *
 * @since   2.0.0
 * @package Wpbit4bytes\Theme\Utils
 */

namespace Wpbit4bytes\Theme\Utils;
...
class Images {
  ...
  public function get_post_image( $size, $post_id = null, $no_image = null ) {
    ...
    if ( has_post_thumbnail( $post_id ) ) {
      ...
      $image_array = [
          'image1'  => esc_url( B4B_IMAGE_URL . 'no-image-' . $size . '.jpg' ),
          'image'  => 'https://via.placeholder.com/1940x768.png?text=bit4bytes.com',
          'width'  => '',
          'height' => '',
      ];
  ...
  public function get_image_from_array( $size, $image_array ) {
    if ( ! empty( $image_array ) ) {
      ...
      $src = B4B_IMAGE_URL . 'no-image-' . $size . '.jpg';
    }
