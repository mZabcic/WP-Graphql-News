...
<?php
echo '<div class="listing-post-list '.$class_list.' listing-post-list--no">';

$the_query = new WP_Query( $section_args ); 
if ( $the_query->have_posts() ) :
while ( $the_query->have_posts() ) : $the_query->the_post(); 
  get_template_part( 'template-parts/listing/post/list',$template  );
endwhile;
endif;
wp_reset_postdata();
